<div style="width: 100%;height: 100%;background: url(images/ISE5008D.png); background-size: 100% 100%;">
  <div style="height:75%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISE5008D Unmanaged Industrial Ethernet Switch
    </div>
...
**The ISE5008D is designed for power, transportation, industrial control, and demanding industrial environments.**
...
| Ports | 8 x 10/100/1000BaseT (RJ45) |
...
| EMC | IEC 61000-4-2/3/4/5/6/8/18 Class 3+ |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/media_1_6.png" width="100%" alt="ISE5008D Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISE5008D</div>
  </div>
  <div style="width: 100%;">
    <div>Note:</div>
...
| Model | Description |
|-------|-------------|
| ISE5008D-P-8GT-24 | 8-port Layer 2 unmanaged Industrial Switch. 8 * 10/100/1000BaseT Ports. IP30 Protection Class, Operating Temperature from -40°C to +75°C. Single power input: 12/24/48 VDC (9.6\~60VDC) or 24 VAC (18\~30 VAC) (Only connect to class 2 power supply). |
