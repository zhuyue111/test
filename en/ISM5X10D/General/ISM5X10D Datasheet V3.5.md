<div style="width: 100%;height: 100%;background: url(images/ISM5010.png); background-size: 100% 100%;">
  <div style="height:75%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISM5X10D Managed Industrial Ethernet Switch
    </div>
    <div style="text-align: center;">
      <div style="display: flex; flex-wrap: wrap; gap: 16px; ">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Public Utility</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Smart Manufacturing</div>
      </div>
      <div style="display: flex; flex-wrap: wrap; gap: 16px;margin-top:16px">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Smart City</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px; ">· Smart Energy</div>
      </div>
    </div>
  </div>
</div>
...
- **PoE Capabilities:** Supports IEEE 802.3af/at PSE, providing up to 30W output power per port (ISM5310D).
...
| Ports | 2 x 100/1000/2500BaseX SFP + 8 x 10/100/1000BaseT (ISM5010D); 8 x PoE 802.3af/at ports (ISM5310D) |
| Switching Performance | 44 Gbps backplane bandwidth; 8K MAC table |
| Dimensions / Weight | 52 mm x 140 mm x 110 mm; 0.7 kg |
| Power | 18\~60 VDC dual redundant (ISM5010D); 48\~57 VDC dual redundant (ISM5310D) |
| Environment | -40 to +75 °C operating; IP40/IP30 |
| Management | Web, CLI, SNMPv1/v2c/v3, RMON; STP/RSTP/MSTP, IGMP Snooping, VLAN |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 45%;">
    <img src="images/ISM5010D.png" width="100%" style="display: block; margin: 0 auto;" alt="ISM5010D Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISM5010D</div>
  </div>
  <div style="width: 45%;">
    <img src="images/ISM5310D.png" width="100%" style="display: block; margin: 0 auto;" alt="ISM5310D Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISM5310D</div>
  </div>
  <div style="width: 100%;">
    <div>Note:</div>
...
|----------------------|---------------|
| <span style="color: green;">**IEEE Standards**</span> | |
...
| IEEE 802 | Networks |
| <span style="color: green;">**RFC Standards**</span> | |
| RFC 768 | UDP |
| RFC 791 | IP |
| RFC 792 | ICMP |
| RFC 793 | TCP |
...
| <span style="color: green;">**Other Protocols**</span> | |
| GMRP | GARP |
| GVRP | GARP |
| SSH2 | Secure Shell 2 |
| IGMP | Snooping |
...
## <span style="color: green;">3.2 Hardware Specifications</span>
...
| Input Voltage | 18\~60 VDC dual redundant input (ISM5010D) <br/> 48\~57 VDC dual redundant input (ISM5310D) |
| Power Consumption | 10 W (ISM5010D) |
| Overload Current Protection | Supported |
| Reverse Polarity Protection | Supported |
| <span style="color: green;">**PoE (ISM5310D)**</span> | |
| PoE 10/100/1000 BaseT Ports | 8 ports |
| Maximum Power | 15.4W (IEEE 802.3af); 30W (IEEE 802.3at) |
| <span style="color: green;">**Electromagnetic Characteristics**</span> | |
| EMI | FCC 47 CFR Part 15 Class A; EN55022 Class A |
| EMS | IEC(EN)61000-4-2, Class 4 <br/> IEC(EN)61000-4-4, Class 4 <br/> IEC(EN)61000-4-5, Class 4 <br/> IEC(EN)61000-4-11, Class 4 <br/> IEC(EN)61000-4-12, Class 4 |
| <span style="color: green;">**Mechanical Characteristics**</span> | |
| Shock | IEC60068-2-27 |
| Freefall | IEC60068-2-31 |
| Vibration | IEC60068-2-6 |
| <span style="color: green;">**Certifications**</span> | |
| Certifications | CE, FCC (ISM5010D / ISM5310D) |
| <span style="color: green;">**Quality Assurance**</span> | |
...
| Category/Parameter | Specification |
|----------------------|---------------|
| <span style="color: green;">**Software Functions**</span> | |
...
# <span style="color: green;">5. Ordering Guide</span>
...
| Model | Description |
|-------|-------------|
| ISM5010D-P-2GSFP-8GT-24 | 10-port Layer2 managed Industrial Switch. 2 \* 100/1000/2500BaseX SFP Ports (SFP module not included), 8 \* 10/100/1000BaseT Ports. 1 Management Serial CLI Port, IP40 Protection Class, Operating Temperature from -40°C to +75°C. Isolated Dual 18-60VDC Power Inputs. |
| ISM5310D-P-2GSFP-8GT-48 | 10-port Layer2 managed Industrial Switch. 2 \* 100/1000/2500BaseX SFP Ports (SFP module not included), 8 \* 802.3af/at PoE 10/100/1000BaseT Ports. 1 Management Serial CLI Port, IP30 Protection Class, Operating Temperature from -40°C to +75°C. Dual 48-57VDC Power Inputs. |
