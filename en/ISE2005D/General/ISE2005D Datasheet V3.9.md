<div style="width: 100%;height: 100%;background: url(images/ISE2005.jpg); background-size: 100% 100%;">
  <div style="height:75%;">
  ...
  <div style="padding-left: 40px;">
    <div style="font-size: 40px; font-weight: bold; color:#000;margin-bottom: 30px;">
      ISE2005D Unmanaged Industrial Ethernet Switch
    </div>
    <div style="text-align: center;">
      <div style="display: flex; flex-wrap: wrap; gap: 16px; ">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Plug-and-play</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· DIN-rail</div>
      </div>
      <div style="display: flex; flex-wrap: wrap; gap: 16px;margin-top:16px">
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px;">· Fanless</div>
        <div style="width: 250px;background-color: #4CAF50; color: white; padding: 8px 8px; border-radius: 6px; font-size: 18px; ">· IP30</div>
      </div>
    </div>
  </div>
</div>
...
**The ISE2005D is designed for power, transportation, industrial control, and demanding industrial environments.**
...
| Ports | 5 x 10/100BaseT |
| Switching Performance | 16 Gbps backplane, Store-and-Forward, 4K MAC |
| Dimensions / Weight | 24 x 100 x 61.8 mm / 0.23 kg |
| Power | 9.6-60 VDC & 18-30 VAC, 5 W |
| Environment | -40 to +75 C operating, IP30 |
| EMC | IEC 61000-4-2/3/4/5/6/18 Class 3, IEC 61000-4-8 Class 5 |
...
<div style="display: flex; align-items: end; flex-wrap: wrap; justify-content: space-between;row-gap: 16px;">
  <div style="width: 100%;">
    <img src="images/media_1_5.jpeg" width="100%" alt="ISE2005D Dimensions" />
    <div style="width: 100%; text-align: center; font-size: 12px;">ISE2005D</div>
  </div>
  <div style="width: 100%;">
    <div>Note:</div>
...
| Dimensions (W × D × H) | 24 mm × 100 mm × 61.8 mm |
| Weight | 0.23 kg |
...
| EMS | IEC(EN)61000-4-2, Class 3; IEC(EN)61000-4-3, Class 3 <br/> IEC(EN)61000-4-4, Class 3; IEC(EN)61000-4-5, Class 3 <br/> IEC(EN)61000-4-6, Class 3; IEC(EN)61000-4-8, Class 5 <br/> IEC(EN)61000-4-18, Class 3 |
...
## <span style="color: green;">DIP Switch Settings</span>
...
| Model | Description |
|-------|-------------|
| ISE2005D-P-5T-24 | 5-port Layer 2 unmanaged Industrial Ethernet Switch. 5 × 10/100 BaseT Ports. IP30 Protection Class, Operating Temperature from -40°C to +75°C. Single power input: 12/24/48 VDC (9.6\~60VDC) or 24 VAC (18\~30 VAC) (Only connect to class 2 power supply). |
